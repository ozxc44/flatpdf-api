...
1. Check [existing issues](https://github.com/ozxc44/flatpdf-api/issues) for ideas
2. [Fork the repo](https://github.com/ozxc44/flatpdf-api/fork)
3. Create a branch: `git checkout -b my-feature`
4. Make your changes
5. [Open a Pull Request](https://github.com/ozxc44/flatpdf-api/compare)

## Good First Issues

Issues with the `good first issue` label are great for newcomers:
https://github.com/ozxc44/flatpdf-api/labels/good%20first%20issue
